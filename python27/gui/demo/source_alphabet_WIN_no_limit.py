...
class source_alphabet(gr.hier_block2):
    def __init__(self, dtype="discrete", limit=10000, randomize=False):
        if(dtype == "discrete"):
            ...
            self.src = blocks.file_source(gr.sizeof_char, "source_material/gutenberg_shakespeare.txt", True)
            ...
            self.src = blocks.file_source(gr.sizeof_short*1, "source_material/stream_32k.fifo", True)
