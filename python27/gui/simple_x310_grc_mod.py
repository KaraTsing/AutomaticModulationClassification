...
# Title: Simple X310 Grc
# Generated: Fri Feb 23 12:37:18 2018
##################################################
...
class simple_x310_grc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        channel_prop = {    'sample_rate': self.samp_rate,        # Input sample rate in Hz
                            ...
                            'N_sinusoids' : 1,           # number of sinusoids used in frequency selective fading simulation
                            ...
                            'delays' : [0.0],  # A list of fractional sample delays making up the power delay profile
                            'mags' : [1],      # A list of magnitudes corresponding to each delay time in the power delay profile
                            ...
                            'snr' : 20}
        src, mod, chan = gen_qpsk(channel_prop)
...
def main(top_block_cls=simple_x310_grc, options=None):
