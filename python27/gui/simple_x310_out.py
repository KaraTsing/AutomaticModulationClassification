## Simple Top Block USRP#!/usr/bin/env python2
# -*- coding: utf-8 -*-
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    channel_prop = {   'sample_rate': 200e3,        # Input sample rate in Hz
    ...
    def __init__(self):
        ...
        # self.channels_cfo_model_0 = channels.cfo_model(
                ...
                # 0
        # )
        # self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_float*1, '192.168.1.187', 45001, 1472, True)
        # self.blocks_udp_sink_1 = blocks.udp_sink(gr.sizeof_gr_complex*1, '192.168.1.187', 45000, 1472, True)
        ...
        mod, chan = gen_qpsk(self.channel_prop)
        
        #randsrc = self.create_rand_block('digital')
        self.analog_random_source_x_0 = blocks.vector_source_b(map(int, numpy.random.randint(0, 255, 1000)), True)

        self.connect((self.analog_random_source_x_0, 0), (mod, 0), (chan, 0))
       
        self.connect(chan, self.uhd_usrp_sink_0)
        self.connect(chan, self.qtgui_freq_sink_x_0)
    ...
    def handle_QPSK(self):
        # generate data 
        #self.set_channel_prop()
        #self.statusLabel.setText("Status: Generating QPSK Data" + " SNR: " + str(self.channel_prop['snr']))
        src, mod, chan = gen_qpsk(self.channel_prop)
        # mod.disconnect()
        # mod_type = transmitters['discrete']
        # mod = mod_type[0]()
        ...
        self.disconnect_all()
        randsrc = self.create_rand_block('digital')
        #self.connect((randsrc, 0), (mod, 0), (chan, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((randsrc, 0), (mod, 0), (chan, 0))

        
        # set up forwarding data over network
        #convert2 = blocks.complex_to_float()
        #self.connect(chan, convert2, self.blocks_udp_sink_0)
        
        #self.connect(chan, self.blocks_udp_sink_1)
        self.connect(chan, self.uhd_usrp_sink_0)
        self.connect(chan, self.qtgui_freq_sink_x_0)
        self.unlock()
    ...
    def handle_BPSK(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating BPSK Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_QAM16(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating QAM16 Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_QAM64(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating QAM64 Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_PAM4(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating PAM4 Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_CPFSK(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating CPFSK Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_GFSK(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating GFSK Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_AMBDSB(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating AMDSB Data" + " SNR: " + str(self.channel_prop['snr']))
        src,mod,chan = gen_amdsb(self.channel_prop)
          
        # set up new display using the given model
        self.lock()
        self.disconnect_all()
        sigsrc =  self.create_rand_block('analog')
    ...
    def handle_AMSSB(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating AMSSB Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_WBFM(self): 
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating WBFM Data" + " SNR: " + str(self.channel_prop['snr']))
    ...
    def handle_8PSK(self):
        # generate data 
        self.set_channel_prop()
        self.statusLabel.setText("Status: Generating 8PSK Data" + " SNR: " + str(self.channel_prop['snr']))
